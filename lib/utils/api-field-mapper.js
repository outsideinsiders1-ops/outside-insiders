...
export function mapNPSToParkSchema(npsPark) {
  ...
  return {
    ...
    state: state, // May still be null if no state info available - these will be skipped
    agency: 'NPS',
...
export function mapRecreationGovToParkSchema(facility, addresses = null) {
  ...
  // 4. Check FacilityAccessibilityText for restrooms
  ...
  return {
    ...
    // Additional fields from detailed facility endpoint
    directions: facility.FacilityDirections || null,
    accessibility: facility.FacilityAccessibilityText || null
  }
}
