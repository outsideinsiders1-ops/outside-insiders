...
// During build, if env vars aren't available, we'll create a dummy client that throws helpful errors
let supabase = null
...
if (supabaseUrl && supabaseKey && 
  ...
  try {
    ...
    // If createClient fails, supabase stays null
    // Functions will handle null client gracefully
  }
}
